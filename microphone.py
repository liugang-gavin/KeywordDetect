...
class Microphone:
    ...
    def __init__(self, pyaudio_instance=None, quit_event=None, decoder=None):
        ...
        for i in range(self.pyaudio_instance.get_device_count()):
            ...
            if name.lower().find(b'default') >= 0 and dev['maxInputChannels'] > 0:
    ...
    def create_decoder():
        ...
        pocketsphinx_data = os.getenv('POCKETSPHINX_DATA', os.path.join(path, 'pocketsphinx'))
        hmm = os.getenv('POCKETSPHINX_HMM', os.path.join(pocketsphinx_data, 'tdt_sc_8k'))
